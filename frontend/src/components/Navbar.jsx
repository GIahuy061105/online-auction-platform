            ...
            onConnect: () => {
                client.subscribe(`/topic/notifications/${userProfile.username}`, (msg) => {
                    ...
                    notification[data.type || 'info']({
                        ...
                        onClick: () => {
                            if (data.auctionId) navigate(`/auction/${data.auctionId}`);
                        }
                    });
                });
            }
        ...
        <>
            <style>{`
                ...
                .navbar-sell-btn {
                    ...
                    box-shadow: 0 2px 12px rgba(14,165,160,0.35) !important;
                    font-family: 'Be Vietnam Pro', sans-serif !important;
                }

                .navbar-sell-btn:hover {
                    transform: translateY(-1px);
                    box-shadow: 0 4px 20px rgba(14,165,160,0.5) !important;
                }
                ...
                @media (max-width: 768px) {
                    ...
                    .navbar-sell-btn span:last-child { display: none; }
                }
            `}</style>
                        ...
                        <Dropdown menu={{ items: menuItems }} placement="bottomRight" trigger={['click']}>
                            <div className="navbar-avatar-wrapper">
                                <Avatar
                                    ...
                                    icon={<UserOutlined />}
                                    style={{
                                        background: 'linear-gradient(135deg, #0d7a76, #0ea5a0)',
                                        flexShrink: 0
                                    }}
                                />
